...
Dans le but dd'une intégration robotisé, l'objectif était de dévellopper un interface homme machine pour les utilisateurs intéragise très facilement avec la cellule.
