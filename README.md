...
Objectif : Concevoir une IHM avec EasyBuilder Pro pour un automate WAGO, dans le cadre de l’intégration d’une cellule robotisée.
...
Dans le cadre d’une intégration robotisée, l’objectif était de développer une interface homme-machine permettant aux utilisateurs d’interagir très facilement avec la cellule.
...
Voici l’automate WAGO PFC300, câblé dans l’armoire électrique de la cellule.
...
Dans le logiciel EasyBuilder Pro de l’IHM, importer le fichier GVL afin de pouvoir configurer les actionneurs.
...
L’objectif était de vérifier le basculement entre le mode local et le mode distant.
...
L’objectif était de vérifier que l’IHM et l’automate communiquent correctement.
...
L’objectif était d’intégrer l’IHM développée dans la cellule.
